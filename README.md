...
| API Testing | REST APIs, Postman, HTTP methods, authentication, environment variables |
...
- REST API testing (CRUD, auth, environment variables)
...
- Complete the TripleTen QA program with a portfolio of 6+ tested projects
- Earn the **ISTQB Foundation Level** certification
- Expand into **automated testing** with Selenium or Pytest
